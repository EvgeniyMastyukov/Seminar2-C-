...
// Андрей, оставить только третью цифру числа по моим соображениям можно было решить, прибегая к массиву, чтобы 
//программе указать на индекс третьей цифры. Но в условии задачи нет про ввод массива, там ввести число. Я подумал, 
//что строка и есть 
//некий массив и посмотрел в инете про свойства строки string. Есть команда char которая вытаскивает нам символ строки
